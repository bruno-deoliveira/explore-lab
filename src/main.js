...
function setCardType(flag) {
  const cards = {
    ...
    elo: ["#CAB04D", "#EC4C30"],
    hipercard: ["#B84646", "#822124"],
    americanexpress: ["#36A58A", "#4AA8C8"],
    default: ["black", "gray"],
  }

  ccBgColor01.setAttribute("fill", cards[flag][0])
  ccBgColor02.setAttribute("fill", cards[flag][1])
  logo.setAttribute("src", `cc-${flag}.svg`)
}
